<template>
    <section class="online-session-default">
        <div class="box-title">在线会话</div>
        <div class="box-operate">
            <el-button  type="primary" size="small" @click="search" class="fr">查询</el-button>
            <el-input v-if="false" v-model="searchKey" size="small" class="searchKey wat fr mr10" placeholder="请输入查询内容"></el-input>
            <el-select
                v-model="systemUser"
                filterable
                size="small"
	...
	export default {
		...
		methods: {
            ...
            getData: async function() {
                ...
                this.isLoading = true;
                that.$axios.get('http://127.0.0.1:8000/terminal/session/line/on/', { params: params})
                    .then(function (response) {
                        let data = response;
                        if (data.status === 200) {
